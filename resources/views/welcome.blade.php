                                ...
                                <div class="product text-center">
                                    ...
                                    <div class="product-details">
                                       ...
                                       <div class="ratings-container">
                        										<a href="{{url('product-detail/'.$prod_val['slug'])}}" class="rating-reviews">Min Qty : {{$product_val['maq'] ? $product_val['maq'] :$product_val['maq']}}</a>
                												</div>
                                ...
                                <div class="product text-center">
                                    ...
                                    <div class="product-details">
                                        <h4 class="product-name"><a href="{{url('product-detail/'.$product_deals['getProduct']['slug'])}}">{{$product_deals['getProduct']['name']}}</a></h4>
                                         <div class="ratings-container">
                        										<a href="{{url('product-detail/'.$prod_val['slug'])}}" class="rating-reviews">Min Qty : {{$product_deals['getProduct']['maq'] ? $product_deals['getProduct']['maq'] :  $product_deals['getProduct']['maq']}}</a>
                												</div>
                                        <div class="product-price">
