									...
									<div class="row">
										@foreach($feature as $val)
											<div class="col-12 mt-2">
												...
												<input class="form-control" name="faetures[{{$val['id']}}]" placeholder="Enter Name" required="required" id="name" type="text" data-parsley-required-message="Please enter your name" value="">
												<span class="text-danger" id="name_error"></span>
											</div>
											</div>
										@endforeach
