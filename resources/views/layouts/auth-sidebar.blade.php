...
<aside class="main-sidebar app-sidebar sidebar-scroll">
			...
			<div class="main-sidebar-body">
				<ul class="side-menu ">
					...
					@if($url == 'admin')
					<li class="slide">
						<a class="side-menu__item" href='{{url("$url/vendor/add")}}'><i class="side-menu__icon fe fe-database"></i><span class="side-menu__label">vendor</span></a>
					</li>
					<li class="slide">
						<a class="side-menu__item" href='{{url("$url/feature/add")}}'><i class="side-menu__icon fe fe-database"></i><span class="side-menu__label">Feature</span></a>
					</li>
					<li class="slide">
						<a class="side-menu__item" href='{{url("$url/category/add")}}'><i class="side-menu__icon fe fe-database"></i><span class="side-menu__label">Category</span></a>
					</li>
					@endif
