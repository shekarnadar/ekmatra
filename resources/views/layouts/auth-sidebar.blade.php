<aside class="main-sidebar app-sidebar sidebar-scroll">
            ...
            <div class="main-sidebar-body">
                <ul class="side-menu ">
                    <li class="slide">
                        <a class="side-menu__item" href="{{url('admin/dashboard')}}"><i class="side-menu__icon fe fe-airplay"></i><span class="side-menu__label">Dashboard</span></a>
                    </li>
                    <li class="slide">
                        <a class="side-menu__item" href="{{url('admin/vendor/add')}}"><i class="side-menu__icon fe fe-database"></i><span class="side-menu__label">vendor</span></a>
                    </li>
