							...
							<div class="sticky-sidebar">
									...
									<div class="widget-body">
									  <ul class="widget-body filter-items item-check price-item">
										...
										<form class="price-range">
											<input
												type="number" name="min_price" id="inputMinPrice" class="min_price text-center"
												placeholder="min">
											<span class="delimiter">-</span>
											<input
												type="number" name="max_price" id="inputMaxPrice" class="max_price text-center"
												placeholder="max">
												<a href="javascript:void(0)" id="go-button" class="btn btn-primary btn-rounded  searchByMinMax">Go</a>
										</form>
									</div>
								</div>
								<!-- End of Collapsible Widget -->
								...
								<div class="widget widget-collapsible">
									...
									<ul class="widget-body filter-items item-check qty-item">
										...
										<li data-minqty="1" data-maxqty="100"><a href="#">Under 100</a></li>
										<li data-minqty="1" data-maxqty="500"><a href="#">Under 500</a></li>
