                    ...
                    <section class="customer-service mb-7">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-6 mb-8">
                                <figure class="br-lg">
                                    <img src="{{url('aboutus/2.jpg')}}" alt="Banner"
                                        width="610" height="500" style="background-color: #CECECC;" />
                                </figure>
                            </div>
                        </div>
                        <p>If you are interested in any of these positions, please send your resume and a cover letter to recruiter@ekmatra.store. We look forward to hearing from you!</p>

                        <p>At Ek Matra Technologies Pvt Ltd, we are committed to creating a diverse and inclusive workplace. We welcome applicants from all backgrounds and are dedicated to providing equal employment opportunities regardless of race, color, religion, sex, national origin, age, disability, or any other legally protected status.</p>
                    </section>
